---
title: "Reproducible research: Peer Graded Assingment 1"
output: 
  html_document: 
    fig_caption: yes
    keep_md: yes
...
```r
setwd("/home/mike/Documents/Learning/ds/Reproduce 1")
...
6. Calculate the differences of the mean and median between the first and second part
